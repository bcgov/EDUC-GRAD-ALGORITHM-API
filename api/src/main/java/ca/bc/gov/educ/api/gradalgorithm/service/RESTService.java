...
public class RESTService {
    ...
    @Autowired
    public RESTService(@Qualifier("algorithmApiClient") WebClient webClient) {
    ...
    public <T> T get(String url, Class<T> clazz, WebClient webClient) {
        ...
        try {
            obj = webClient
                    .get()
                    .uri(url)
                    .headers(h -> h.set(GradAlgorithmAPIConstants.CORRELATION_ID, ThreadLocalStateUtil.getCorrelationID()))
                    .retrieve()
