...
public class RESTServicePOSTTest {
    ...
    @Before
    public void setUp(){
        Mockito.reset(algorithmApiClient, responseMock, requestHeadersMock, requestBodyMock, requestBodyUriMock);
    ...
    public void testPost_GivenProperData_Expect200Response(){
        ...
        byte[] response = this.restService.post(TEST_URL, TEST_BODY, byte[].class, algorithmApiClient);
    ...
    public void testPost_Given4xxErrorFromService_ExpectServiceError() {
        ...
        this.restService.post(TEST_URL, TEST_BODY, byte[].class, algorithmApiClient);
    }
